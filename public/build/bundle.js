...
var app = (function () {
    ...
    function create_default_slot_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 29, 27, 729);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 30, 27, 828);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 31, 16, 920);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-danger");
    			add_location(button1, file$4, 32, 8, 991);
    		},
    		m: function mount(target, anchor) {
    ...
    // (29:5) <RamRow exClass="row-cols-auto">
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:5) <RamRow exClass=\\\"row-cols-auto\\\">",
    		ctx
    	});
    ...
    function create_thead_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$4, 38, 16, 1162);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$4, 39, 16, 1201);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$4, 40, 16, 1244);
    			attr_dev(th3, "scope", "col");
    			add_location(th3, file$4, 41, 16, 1286);
    			add_location(tr, file$4, 37, 12, 1141);
    			attr_dev(thead, "slot", "thead");
    			add_location(thead, file$4, 36, 8, 1108);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, thead, anchor);
    			append_dev(thead, tr);
    ...
    function create_tbody_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$4, 46, 16, 1411);
    			add_location(td0, file$4, 47, 16, 1450);
    			add_location(td1, file$4, 48, 16, 1480);
    			add_location(td2, file$4, 49, 16, 1510);
    			add_location(tr0, file$4, 45, 12, 1390);
    			attr_dev(th1, "scope", "row");
    			add_location(th1, file$4, 52, 16, 1579);
    			add_location(td3, file$4, 53, 16, 1618);
    			add_location(td4, file$4, 54, 16, 1649);
    			add_location(td5, file$4, 55, 16, 1683);
    			add_location(tr1, file$4, 51, 16, 1558);
    			attr_dev(th2, "scope", "row");
    			add_location(th2, file$4, 58, 16, 1756);
    			attr_dev(td6, "colspan", "2");
    			add_location(td6, file$4, 59, 16, 1795);
    			add_location(td7, file$4, 60, 16, 1847);
    			add_location(tr2, file$4, 57, 16, 1735);
    			attr_dev(tbody, "slot", "tbody");
    			add_location(tbody, file$4, 44, 8, 1357);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tbody, anchor);
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:4) <RamContainer type=\\\"fluid\\\">",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 26, 1, 587);
    			add_location(main, file$4, 25, 0, 579);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
